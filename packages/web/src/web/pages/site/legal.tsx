...
const TERMS: { h: string; p: string }[] = [
  { h: "1. Who we are", p: "Nguzo Africa Ltd ('Nguzo', 'we', 'us') is a cargo and machinery coordination service headquartered in Dar es Salaam, Tanzania, operating across the Southern, Central and Northern corridors of East Africa. We connect clients who need transport or equipment with the owners who provide it, and we coordinate the deal end to end." },
  { h: "2. Our role", p: "We are a neutral coordinator. We do not own trucks or machinery, and we do not provide unsecured lending. We facilitate verification, routing, documentation and settlement between clients and owners, and charge a flat 7% service fee on completed deals." },
  ...
  { h: "5. Settlement", p: "On client sign-off of a completed job, the supplier payout is calculated as the funded amount less our 7% fee and any emergency-parts credit drawn during the job. Itemized records are made available to both parties." },
...
const PRIVACY: { h: string; p: string }[] = [
  ...
  { h: "5. Your rights", p: "You may request access to, correction of, or deletion of your personal data by contacting us at hello@nguzo.africa, subject to legal and operational record-keeping requirements." },
  { h: "6. Contact", p: "Questions about privacy? Email us at hello@nguzo.africa and a real person will respond." },
];
