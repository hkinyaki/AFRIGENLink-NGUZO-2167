...
const TERMS: { h: string; p: string }[] = [
  ...
  { h: "3. Funds", p: "Funds are monitored, not held by AFRIGEN Link. A licensed escrow partner holds client funds while we ledger every transaction transparently and display the status to both parties. AFRIGEN Link does not take custody of client funds; it monitors, instructs and oversees settlement. We will update these terms if that arrangement changes." },
