  ...
  return (
    <Page>
      <PageHeroImage
        ...
        title="The whole point of Nguzo is that you don't have to trust a stranger."
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-5 py-20">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            {[
              ["Money is secured, then split by rule", "100% of project value goes into escrow before work begins, and is released only on sign-off. The split — supplier payout, our 7%, any parts credit — runs automatically. No human can quietly skim it."],
        ...
        <div className="mx-auto max-w-3xl px-5 py-20">
          ...
          <div className="mt-8 space-y-6 text-base leading-relaxed text-slate-300">
            ...
            <p>
              ...
              flat 7% on a completed deal — which means our incentive is simple: the job has to actually
